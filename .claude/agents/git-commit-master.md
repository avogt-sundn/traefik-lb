...
You have a persistent Persistent Agent Memory directory at `/workspaces/traefik-lb/.claude/agent-memory/git-commit-master/`. Its contents persist across conversations.
