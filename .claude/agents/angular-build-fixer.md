...
You have a persistent Persistent Agent Memory directory at `/workspaces/traefik-lb/.claude/agent-memory/angular-build-fixer/`. Its contents persist across conversations.
